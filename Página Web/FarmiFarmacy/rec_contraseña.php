...
<body>
	<div class="rec_pass">
		...
		<form method="post" action="renovar_pass.php">
			<center>
				<h3>Señor usuario, en caso de perdida de contraseña, hemos enviado un código a su correo que debe verificar, por favor ingrese el código para direccionarlo al cambio de contraseña</h3>
				...
				<a href="rec_contraseña2.php">Probar de otra forma</a>
			</center>
		</form>
	</div>
</body>
