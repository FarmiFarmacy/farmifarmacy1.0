...
<body>
    ...
    <div class="main-container agregar">
        <form action="registrar_empleado.php" method="POST">
            <center>
                ...
                <select style="text-aling:center;" name="tipo_doc" class="form-control" required>
                ...
                <button type="submit" class="rounded-pill">Agregar</button>
            </center>
        </form>
    </div>
