...
<?php
  if(isset($_POST['enviar'])){
    $req_dates = array('fecha-inicio','fecha-final');
        ...
        <tbody>
          <?php foreach($results as $result): ?>
           <tr>
              ...
              <td class="text-right"><?php echo remove_junk($result['total_venta']);?></td>
              <td class="text-right"><?php echo remove_junk($result['total_precio_compra']);?></td>
          </tr>
        <?php endforeach; ?>
        </tbody>
        <tfoot>
