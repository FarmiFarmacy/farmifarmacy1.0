...
<!DOCTYPE html>
  ...
  <?php  if ($session->isUserLoggedIn(true)): ?>
    <header id="header">
      <div class="logo pull-left"> FARMIFARMACY </div>
        ...
        <ul class="info-menu list-inline list-unstyled">
          <li class="profile">
            <a href="#" data-toggle="dropdown" class="toggle" aria-expanded="false">
              <img src="uploads/users/<?php echo $user['imagen'];?>" alt="imagen_usuario" class="img-circle img-inline">
    ...
    <div class="sidebar">
      ...
      <?php elseif($user['nivel_usuario'] === '0'): ?>
        <!-- User menu -->
