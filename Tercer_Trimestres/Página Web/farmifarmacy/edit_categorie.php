...
if(isset($_POST['edit_cat'])){
  ...
  $cat_name = remove_junk($db->escape($_POST['nombre_categoria']));
  if(empty($errors)){
       ...
       <div class="panel-body">
         <form method="post" action="edit_categorie.php?id=<?php echo (int)$categorie['id'];?>">
           <div class="form-group">
               <input type="text" class="form-control" name="nombre_categoria" value="<?php echo remove_junk(ucfirst($categorie['nombre']));?>">
           </div>
