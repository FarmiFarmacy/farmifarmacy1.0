              ...
              <div class="form-group">
                <div class="input-group">
                  <span class="input-group-btn">
                    <input type="file" name="actualizar_archivo" multiple="multiple" class="btn btn-primary btn-file"/>
                 </span>

                 <button type="submit" name="enviar" class="btn btn-default">Subir</button>
               </div>
              </div>
             </form>
            </div>
