create database farifarmacy;
use database farifarmacy;
...
create table usuario (
    ...
    primary key (id_usuario, tipo_documento_t_doc, carro_de_compras)
);
...
create table producto (
    ...
    primary key (cod_producto, lote_cod_lote)
);
...
alter table usario_has_rol add
