...
<body>
    ...
    <div class="main-container empleados">
		<div class="login-container">
			<form action="login_empleado.php" method="POST">
				<img class="avatar" src="imagenes/empleado.png" alt="">
				<h2>Empleado</h2>
				<div class="input-div one">
					...
					<div>
						<h5>Documento</h5>
						<input type="text" class="input" name="documento">
					</div>
				</div>
				...
				<button type="submit" class="rounded-pill">Ingresar</button>
			</form>
		</div>
	</div>
